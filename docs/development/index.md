...
- **Notes** — explanatory notes on concepts that span several modules and are
  easier to read once, whole, than to reconstruct from the code:
  [routing buckets](notes/routing-buckets.md) and
  [the catalog resolution workflow](notes/catalog-resolution.md).
